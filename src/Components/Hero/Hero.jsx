...
const Hero = () => {
    return (
        <section className='text-center space-y-5 p-5 py-10' id='home'>
            ...
            <h1 className='font-source-pro text-4xl font-bold text-slate-900'>HI, I'M MARGUB. I'M A MERN STACK DEVELOPER</h1>
            </Slide>
            ...
            <a href='https://drive.google.com/file/d/1bOc0FWUYgpEx7RNrT_Vg5YEdsYF5VXHY/view?usp=sharing' className='inline-block border-primary border-2 px-5 py-3 rounded-md bg-slate-900 bg-opacity-90 text-white font-semibold font-source-pro uppercase'>Download Resume</a>
            </Slide>
