      ...
      <div className="container mx-auto p-5 py-20">
        ...
        <div>
          <form
            onSubmit={sendEmail}
            ref={form}
            className="max-w-3xl mx-auto border border-primary mt-5 p-5 rounded-md space-y-3"
          >
            <div className="flex flex-col md:flex-row gap-3">
              <div className="flex-flex col md:w-1/2">
                ...
                <input
                  ...
                  name="from_name"
                  className="px-5 py-3 outline-none rounded-md w-full focus:bg-primary focus:text-white placeholder:focus:text-white"
                  required
                />
              </div>
              <div className="flex flex-col md:w-1/2">
                ...
                <input
                  ...
                  name="from_email"
                  className="px-5 py-3 outline-none rounded-md focus:bg-primary focus:text-white placeholder:focus:text-white"
                  required
                />
              </div>
            </div>
            <div className="flex flex-col">
              <label className="text-white text-sm mb-1" htmlFor="message">
                Your message
              </label>
              <textarea
            ...
            <button
              type="submit"
              disabled={disabled}
              className="inline-block border-primary border-2 px-5 py-3 rounded-md bg-slate-900 bg-opacity-90 text-white font-semibold font-source-pro uppercase w-full"
            >
              Send Message
            </button>
          </form>
